        ...
        <div>
            ...
            <div className="contenido">
                            ...
                            <Row className=" position-relative">
                                ...
                                <Col className="col-8 mt-4 column1 ">
                                        ...
                                        <Col>
                                            <div className="cardDatos mx-auto">
                                                <Row>
                                                    ...
                                                    <Col className="col-9 mt-3 mx-auto">
                                                         <label className="lblCard">  (Código) - {cookie.get('CodEstudiante')}</label>   
                                                    </Col>
                                                </Row>
                                    ...
                                    <div className="c">
                                        ...
                                        <div className="mx-2 d-inline">                                
                                            <b className="d-inline lblValidate">Aceptar los <a className="linkP d-inline" onClick={()=>abrirCerrarModalWarning()} > términos y condiciones </a> </b>
                                        </div>
                                    </div>
                                </Col>
                            </Row>
                ...
                <Modal isOpen={modalEditar} size="lg">
                    ...
                    <div className="form-group">
                        <Row>
                            ...
                            <label>Codigo: </label>
                            <br/> 
                            <input type="text" className="form-control" value={cookie.get('CodEstudiante')} name="IDEstudiante" readOnly />
                            <br/>
                            <label>Nombres: </label>
                            <br/> 
                            ...
                            <label>Correo: </label>
                            <br/> 
                            <input  placeholder="Ej. ejemplo@ejemplo.com"  type="email" className="form-control" value={cookie.get('Email')} name="correo" />
                            <br/>       
                            <label>Celular :</label>
                            <br />
                            <input placeholder="Ej. 985687898" type="text" className="form-control" value={cookie.get('Celular')} name="telefono" />
                            <br/>
                            </Col>
                        </Row>
                        <Row>
                    ...
                    <ModalFooter>
                    <button className="btnColoG" >Guardar</button>{""}
                ...
                <Modal isOpen={modalEditarContra} centered>
                    ...
                    <ModalFooter>
                    <button className="btnColoG" onClick={()=>putPass()} >Guardar</button>{""}
                ...
                <Modal isOpen={warningView} centered>
                    ...
                    <ModalHeader>
                      <ImIcons.ImWarning />Términos y Condiciones
                    </ModalHeader>
                    <ModalBody>
