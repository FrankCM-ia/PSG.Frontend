                    ...
                    <div className="Principal2 ">
                        ...
                        <div className ="contDatos">
                            <Row className=" position-relative">
                                ...
                                <Col className="col-8 mt-3 column1 ">
                                        ...
                                        <Col>
                                            <div className="cardDatos mx-auto">
                                                ...
                                                <Col className="col-1 pt-2">
                                                    ...
                                                    <Col className="col-9 mt-3 mx-auto my-2">
                ...
                <Modal isOpen={modalEditar} size="lg">
                    ...
                    <div className="form-group">
                        ...
                        <Col>
                            ...
                            <input placeholder="Ej.  Urb. Abancay L-8" type="text" className="form-control" value={cookie.get('Direccion')} name="direccion"/>
                            </Col></Row>                 
